...
import zqit.syncLock.pulgins.redis.base.RedisUtils;
import zqit.syncLock.pulgins.redis.syncLock.anno.SyncLockAble;
...
public class RedisService {
	...
	public String getRedisCache() {
		try {
			...
			return "getRedisCache success , value = " + obj;
		} catch (Exception e) {
			e.printStackTrace();
	...
	// 同步锁测试
	@SyncLockAble(key = "service-B", expire = 10, tryTimeout = 10)
	public void setBLock() throws InterruptedException {
		// 程序运行...
		Thread.sleep(8000);
	}
